...
class FolioActivity : AppCompatActivity(), FolioActivityCallback, MediaControllerCallback,
    ...
    private var direction1: Config.Direction = Config.Direction.VERTICAL
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val config = getSavedConfig(applicationContext);
        if(config != null) {
...
//        mFolioPageViewPager!!.setDirection(newDirection)
    ...
    override fun getDirection1(): Config.Direction {
        return direction1
    }
